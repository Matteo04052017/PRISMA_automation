...
def is_calibrated(camera_code, day):
    ...
    check_files = ["assoc.txt", "astro_covar.txt", "astro_error.txt", 
    "astro_param.txt", "astro_report.pdf", "astro_sigma.txt", "astro_solution.txt",
    "photo_param.txt", "photo_report.pdf", "photo_sigma.txt", "photo_solution.txt"]
